...
export const Header = () => {
  return (
    <div className="relative overflow-hidden bg-[#EDF0F5] h-3/4"> {/* Adjusted height here */}
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-auto mb-10 lg:mt-14">
          <img
            className="w-full max-w-xs h-auto object-contain mx-auto lg:max-w-md"
